...
class TSMixin:
    ...
    def get_outliers(self, data=None, cols=[], get_indeces=False):
        ...
        try:
            ...
            raise Exception(
                "luminol package not found. Please install with: pip install git+https://github.com/linkedin/luminol.git"
            )
        ...
        if self.ts_identifiers and data is None:
            ...
            if isinstance(outlier_data, str):
                return outlier_data
    ...
    def get_time_series_analysis(self):
        ...
        if self.ts_identifiers:
            ...
            ts_analysis_dict["first_period_occurrences"] = (
                self.plot_first_period_occurrence()
            )
            ts_analysis_dict["last_period_occurrences"] = (
