...
class ExcelDashboard:
    ...
    def to_excel(self, worksheet, workbook, excel_writer):
        """Excel dashboard class."""
        for component in self.components:
            component.save_to(worksheet, workbook, excel_writer)

    def save_to(self, excel_writer, sheet_name=None):
        """Excel dashboard class."""
        ...
        self.to_excel(worksheet, workbook, excel_writer)
        # return workbook
...
class ExcelReport:
    ...
    def __init__(self, filename, file_path=""):
        ...
        overall_final_path = file_path + filename
        os.makedirs(os.path.dirname(overall_final_path), exist_ok=True)
    ...
    def save(self):
        ...
        for dashboard in self.dashboards:
            dashboard.save_to(self.excel_writer)
